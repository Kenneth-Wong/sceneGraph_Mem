...
__C.TRAIN.STEPSIZE = [120000]  # [30000]
...
__C.TRAIN.POS_REL_FRACTION = 0.75
...
# Number of top scoring boxes to keep before apply NMS to RPN proposals
__C.TEST.RPN_PRE_NMS_TOP_N = -1 #6000
...
__C.COCO_DIR = osp.abspath(osp.join(__C.DATA_DIR, 'coco17'))
...
__C.ANCHOR_SCALES = [2.22152954, 4.12315647, 7.21692515, 12.60263013, 22.7102731]  # [8, 16, 32]

# Anchor ratios for RPN
__C.ANCHOR_RATIOS = [0.23232838, 0.63365731, 1.28478321, 3.15089189]  # [0.5, 1, 2]
...
__C.REL_MAP_WEIGHT = 0.2
__C.OBJ_MAP_WEIGHT = 0.2

__C.RATIO = 1.2

__C.REDUCE_RATIO = 16

__C.ATTENTION_KSIZE = 3


def get_output_dir(imdb, tag, extra_tag=None):
...
def get_output_tb_dir(imdb, tag, extra_tag=None):
