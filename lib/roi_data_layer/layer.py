...
class RoIDataLayer(object):
    ...
    def __init__(self, imdb, roidb, bbox_means, bbox_stds, is_rel=True, random=False):
    ...
    def _get_next_minibatch(self, db_inds):
        ...
        if cfg.TRAIN.USE_RPN_DB and self._is_rel:
        ...
        return get_minibatch(minibatch_db, self._num_classes, is_rel=self._is_rel)
