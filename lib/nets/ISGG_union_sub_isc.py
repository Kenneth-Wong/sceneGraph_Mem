...
class DualGraph_union_sub_isc(BaseMemory, Network):
    def __init__(self):
        self._n_iter = 2
        self._predictions = {}
    ...
    def _build_conv(self, is_training):
        ...
        with tf.variable_scope(self._scope, self._scope):
            ...
            rel_union_sub_isc_pool5 = self._union_sub_isc(rel_union_pool5, hole_region, "rel_pool5")

            rel_pool5_nb = tf.stop_gradient(rel_union_sub_isc_pool5, name="rel_pool5_nb")

        fc7 = self._head_to_tail(pool5, is_training)
        rel_fc7 = self._head_to_tail(rel_union_sub_isc_pool5, is_training, prefix='rel')
...
class vgg16(DualGraph_union_sub_isc, vgg16):
    def __init__(self):
        DualGraph_union_sub_isc.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(DualGraph_union_sub_isc, resnetv1):
...
class mobilenetv1(DualGraph_union_sub_isc, mobilenetv1):
    def __init__(self):
        DualGraph_union_sub_isc.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
