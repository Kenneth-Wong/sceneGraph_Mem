...
class Memory_ISGG_iscbox(DualGraph, Network):
    def __init__(self):
        self._predictions = {}
...
class vgg16(Memory_ISGG_iscbox, vgg16):
    def __init__(self):
        Memory_ISGG_iscbox.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(Memory_ISGG_iscbox, resnetv1):
...
class mobilenetv1(Memory_ISGG_iscbox, mobilenetv1):
    def __init__(self):
        Memory_ISGG_iscbox.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
