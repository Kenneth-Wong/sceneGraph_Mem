...
class Attend_Memory_ISGG_relmix(DualGraph, Network):
    def __init__(self):
        self._predictions = {}
...
class vgg16(Attend_Memory_ISGG_relmix, vgg16):
    def __init__(self):
        Attend_Memory_ISGG_relmix.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(Attend_Memory_ISGG_relmix, resnetv1):
...
class mobilenetv1(Attend_Memory_ISGG_relmix, mobilenetv1):
    def __init__(self):
        Attend_Memory_ISGG_relmix.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
