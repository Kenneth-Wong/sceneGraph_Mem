...
class Memory_ISGG_relmix_v2(DualGraph, Network):
    def __init__(self):
        self._predictions = {}
...
class vgg16(Memory_ISGG_relmix_v2, vgg16):
    def __init__(self):
        Memory_ISGG_relmix_v2.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(Memory_ISGG_relmix_v2, resnetv1):
...
class mobilenetv1(Memory_ISGG_relmix_v2, mobilenetv1):
    def __init__(self):
        Memory_ISGG_relmix_v2.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
