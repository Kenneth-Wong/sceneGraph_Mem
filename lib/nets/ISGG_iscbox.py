...
class DualGraph_iscbox(BaseMemory, Network):
    def __init__(self):
        self._n_iter = 2
        self._predictions = {}
...
class vgg16(DualGraph_iscbox, vgg16):
    def __init__(self):
        DualGraph_iscbox.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(DualGraph_iscbox, resnetv1):
...
class mobilenetv1(DualGraph_iscbox, mobilenetv1):
    def __init__(self):
        DualGraph_iscbox.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
