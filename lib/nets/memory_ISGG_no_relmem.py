...
class Memory_ISGG_no_relmem(DualGraph, Network):
    def __init__(self):
        self._predictions = {}
...
class vgg16(Memory_ISGG_no_relmem, vgg16):
    def __init__(self):
        Memory_ISGG_no_relmem.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
        self._scope = 'vgg_16'


class resnetv1(Memory_ISGG_no_relmem, resnetv1):
...
class mobilenetv1(Memory_ISGG_no_relmem, mobilenetv1):
    def __init__(self):
        Memory_ISGG_no_relmem.__init__(self)
        self._feat_stride = [16, ]
        self._feat_compress = [1. / float(self._feat_stride[0]), ]
