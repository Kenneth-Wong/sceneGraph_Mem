...
def get_vg_imdb(split, task, num_im, num_val_im):
    return visual_genome(split, task, num_im, num_val_im, filter_empty_rels=(task == 'rel' and split == 'train'),
                         filter_duplicate_rels=split == 'train')
